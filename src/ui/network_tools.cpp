...
void NetworkToolsWidget::addUtilitySections(QVBoxLayout* layout)
{
    ...
    m_dnsHosts_->setPlaceholderText(
        U8("\xD0\xBF\xD1\x80\xD0\xBE\xD0\xB4\x2D\xD1\x85\xD0\xBE\xD1\x81\xD1\x82\x2E\xD0\xB8\xD0\xB3\xD1\x80\xD1\x8B\x2E\xD1\x80\xD1\x83\x2C\x20\x73\x74\x65\x61\x6D\x63\x6F\x6D\x6D\x75\x6E\x69\x74\x79\x2E\x63\x6F\x6D"));
    ...
    auto* mtrBtn = makeBtn(U8("\xD0\x9F\xD1\x80\xD0\xBE\xD0\xB2\xD0\xB5\xD1\x80\xD0\xB8\xD1\x82\xD1\x8C\x20\xD0\xBC\xD0\xB0\xD1\x80\xD1\x88\xD1\x80\xD1\x83\xD1\x82"), mtrGroup);
    ...
    auto* wifiBtn = makeBtn(U8("\xD0\xA1\xD0\xBA\xD0\xB0\xD0\xBD\xD0\xB8\xD1\x80\xD0\xBE\xD0\xB2\xD0\xB0\xD1\x82\xD1\x8C\x20\xD1\x81\xD0\xB5\xD1\x82\xD0\xB8"), wifiGroup);
    ...
    connect(wifiBtn, &QPushButton::clicked, this, [this, wifiBtn]() {
        runAsync(this, m_wifi_, wifiBtn, []() -> std::string {
            ...
            if (nets.empty())
                return US("\xD0\xA1\xD0\xB5\xD1\x82\xD0\xB8\x20\xD0\xBD\xD0\xB5\x20\xD0\xBD\xD0\xB0\xD0\xB9\xD0\xB4\xD0\xB5\xD0\xBD\xD1\x8B\x20\x28\x57\x69\x2D\x46\x69\x20\xD0\xBE\xD1\x82\xD0\xBA\xD0\xBB\xD1\x8E\xD1\x87\xD0\xB5\xD0\xBD\x3F\x29");
            std::ostringstream out;
            ...
            if (count24 >= 2) {
                ...
                out << "\n" << US("\xD0\xA1\xD0\xBE\xD0\xB2\xD0\xB5\xD1\x82\x3A\x20\xD0\xBC\xD0\xB5\xD0\xBD\xD0\xB5\xD0\xB5\x20\xD0\xB7\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB6\xD0\xB5\xD0\xBD\xD0\xBD\xD1\x8B\xD0\xB9\x20\xD0\xBA\xD0\xB0\xD0\xBD\xD0\xB0\xD0\xBB\x3A\x20") << ch;
            }
            return out.str();
        });
    });
    ...
    auto* connsGroup = new QGroupBox(U8("\xD0\xA1\xD0\xBE\xD0\xB5\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB5\xD0\xBD\xD0\xB8\xD1\x8F\x20\xD0\xB8\xD0\xB3\xD1\x80\xD1\x8B"), this);
    auto* connsL = new QVBoxLayout(connsGroup);
    auto* connsBtn = makeBtn(U8("\xD0\x9F\xD0\xBE\xD0\xBA\xD0\xB0\xD0\xB7\xD0\xB0\xD1\x82\xD1\x8C\x20\xD0\xB8\x20\xD0\xBF\xD0\xB8\xD0\xBD\xD0\xB3\xD0\xBE\xD0\xBD\xD1\x83\xD1\x82\xD1\x8C"), connsGroup);
    ...
    connect(connsBtn, &QPushButton::clicked, this, [this, connsBtn]() {
        runAsync(this, m_conns_, connsBtn, []() -> std::string {
            ...
            if (!game)
                return US("\xD0\x98\xD0\xB3\xD1\x80\xD0\xB0\x20\xD0\xBD\xD0\xB5\x20\xD0\xB7\xD0\xB0\xD0\xBF\xD1\x83\xD1\x89\xD0\xB5\xD0\xBD\xD0\xB0\x2E");
            auto eps = remoteTcpEndpointsForPid(game->pid);
            std::ostringstream out;
            out << US("\xD0\x9F\xD1\x80\xD0\xBE\xD1\x86\xD0\xB5\xD1\x81\xD1\x81\x3A\x20") << game->path << "\n\n";
            if (eps.empty()) out << US("\xD0\x9D\xD0\xB5\xD1\x82\x20\xD0\xB0\xD0\xBA\xD1\x82\xD0\xB8\xD0\xB2\xD0\xBD\xD1\x8B\xD1\x85\x20\x54\x43\x50\x2D\xD1\x81\xD0\xBE\xD0\xB5\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB5\xD0\xBD\xD0\xB8\xD0\xB9\x2E\x5C\x6E");
            int shown = 0;
            SpeedTest st;
            ...
            if (!listeners.empty()) {
                out << US("\x5C\x6E\xD0\xA1\xD0\xBB\xD1\x83\xD1\x88\xD0\xB0\xD0\xB5\xD1\x82\x20\xD0\xBF\xD0\xBE\xD1\x80\xD1\x82\xD1\x8B\x3A\x20");
    ...
    // ---- 4. Path MTU (DF probe) --------------------------------------------
    auto* mtuGroup = new QGroupBox(U8("\x4D\x54\x55\x20\xD0\xBF\xD1\x83\xD1\x82\xD0\xB8\x20\x28\x44\x46\x2D\x70\x72\x6F\x62\x65\x29"), this);
    auto* mtuL = new QVBoxLayout(mtuGroup);
    auto* mtuBtn = makeBtn(U8("\xD0\x9E\xD0\xBF\xD1\x80\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8\xD1\x82\xD1\x8C\x20\x4D\x54\x55"), mtuGroup);
    ...
    connect(mtuBtn, &QPushButton::clicked, this, [this, mtuBtn]() {
        runAsync(this, m_mtu_, mtuBtn, [this]() -> std::string {
            ...
            if (!netscan::icmpDfProbe(ip.toStdString(), lo, 1500).ok) {
                ...
                if (lo <= 576) return US("\xD0\xA6\xD0\xB5\xD0\xBB\xD1\x8C\x20\xD0\xBD\xD0\xB5\x20\xD0\xBE\xD1\x82\xD0\xB2\xD0\xB5\xD1\x87\xD0\xB0\xD0\xB5\xD1\x82\x2E");
            }
            hi = lo + 500;
            ...
            return US("\x50\x61\x74\x68\x20\x4D\x54\x55\x20\xE2\x89\x88\x20") + std::to_string(lo + 28) +
                    US("\x20\xD0\xB1\xD0\xB0\xD0\xB9\xD1\x82\x20\x28\x70\x61\x79\x6C\x6F\x61\x64\x20") + std::to_string(lo) + ")";
        });
    });
    ...
    auto* natBtn = makeBtn(U8("\xD0\x9E\xD0\xBF\xD1\x80\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8\xD1\x82\xD1\x8C\x20\x4E\x41\x54"), natGroup);
    ...
    connect(natBtn, &QPushButton::clicked, this, [this, natBtn]() {
        runAsync(this, m_nat_, natBtn, []() -> std::string {
            ...
            std::string ip1, ip2;
            if (!resolveStun("stun.l.google.com", ip1)) return US("\x53\x54\x55\x4E\x20\xD0\xBD\xD0\xB5\xD0\xB4\xD0\xBE\xD1\x81\xD1\x82\xD1\x83\xD0\xBF\xD0\xB5\xD0\xBD\x2E");
            ...
            if (!ok1) return US("\x53\x54\x55\x4E\x20\xD0\xBD\xD0\xB5\x20\xD0\xBE\xD1\x82\xD0\xB2\xD0\xB5\xD1\x82\xD0\xB8\xD0\xBB\x2E");

            std::ostringstream out;
            out << US("\xD0\x92\xD0\xBD\xD0\xB5\xD1\x88\xD0\xBD\xD0\xB8\xD0\xB9\x20\x49\x50\x3A\x20") << m1 << "\n";
            if (ok2) {
                out << US("NAT\x3A\x20") << netutils::classifyNat(m1 == m2) << "\n";
                if (m1 != m2)
                    out << US("");
                else
                    out << US("\x43\x6F\x6E\x65\x2D\x4E\x41\x54\x20\xD0\xBE\xD0\xB1\xD1\x8B\xD1\x87\xD0\xBD\xD0\xBE\x20\xD1\x85\xD0\xBE\xD1\x80\xD0\xBE\xD1\x88\x20\xD0\xB4\xD0\xBB\xD1\x8F\x20\xD0\xB8\xD0\xB3\xD1\x80\x2E");
            }
            out << "\nLocal IP: " << localIp();
            return out.str();
        });
    ...
    // ---- 6. Ports -----------------------------------------------------------
    auto* portsGroup = new QGroupBox(U8("\xD0\x9F\xD0\xBE\xD1\x80\xD1\x82\xD1\x8B\x20\xD0\xB8\x20\xD1\x81\xD0\xBB\xD1\x83\xD1\x88\xD0\xB0\xD1\x82\xD0\xB5\xD0\xBB\xD0\xB8"), this);
    auto* portsL = new QVBoxLayout(portsGroup);
    auto* portsBtn = makeBtn(U8("\xD0\x9F\xD1\x80\xD0\xBE\xD0\xB2\xD0\xB5\xD1\x80\xD0\xB8\xD1\x82\xD1\x8C\x20\xD0\xBF\xD0\xBE\xD1\x80\xD1\x82\xD1\x8B"), portsGroup);
    ...
    connect(portsBtn, &QPushButton::clicked, this, [this, portsBtn]() {
        runAsync(this, m_ports_, portsBtn, [this]() -> std::string {
            ...
            std::ostringstream out;
            out << US("\xD0\x94\xD0\xBE\xD1\x81\xD1\x82\xD1\x83\xD0\xBF\xD0\xBD\xD0\xBE\xD1\x81\xD1\x82\xD1\x8C\x20\x54\x43\x50\x20\xD0\xBF\xD0\xBE\xD1\x80\xD1\x82\xD0\xBE\xD0\xB2\x3A\x20") << ip.toStdString() << "\n";
            for (auto& pr : common) {
            ...
            if (auto game = discoverRunningGameProcess()) {
                ...
                if (!l.empty()) {
                    out << US("\x5C\x6E\xD0\x98\xD0\xB3\xD1\x80\xD0\xB0\x20\xD1\x81\xD0\xBB\xD1\x83\xD1\x88\xD0\xB0\xD0\xB5\xD1\x82\x3A\x20");
                    for (auto p : l) out << p << " ";
                    out << "\n";
                }
            }
    ...
    // ---- 7. DNS compare -------------------------------------------------------
    auto* dnsCmpGroup = new QGroupBox(U8("\x44\x4E\x53\x3A\x20\xD1\x81\xD0\xB8\xD1\x81\xD1\x82\xD0\xB5\xD0\xBC\xD0\xBD\xD1\x8B\xD0\xB9\x20\x76\x73\x20\x31\x2E\x31\x2E\x31\x2E\x31\x20\x76\x73\x20\x38\x2E\x38\x2E\x38\x2E\x38"), this);
    auto* dnsCmpL = new QVBoxLayout(dnsCmpGroup);
    auto* dnsCmpBtn = makeBtn(U8("\xD0\xA1\xD1\x80\xD0\xB0\xD0\xB2\xD0\xBD\xD0\xB8\xD1\x82\xD1\x8C\x20\x44\x4E\x53"), dnsCmpGroup);
    ...
    // ---- 8. Bufferbloat ---------------------------------------------------------
    auto* bloatGroup = new QGroupBox(U8("\x42\x75\x66\x66\x65\x72\x62\x6C\x6F\x61\x74\x20\x28\xD0\xBF\xD0\xB8\xD0\xBD\xD0\xB3\x20\xD0\xBF\xD0\xBE\xD0\xB4\x20\xD0\xBD\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB7\xD0\xBA\xD0\xBE\xD0\xB9\x29"), this);
    auto* bloatL = new QVBoxLayout(bloatGroup);
    auto* bloatBtn = makeBtn(U8("\xD0\x97\xD0\xB0\xD0\xBC\xD0\xB5\xD1\x80\xD0\xB8\xD1\x82\xD1\x8C"), bloatGroup);
    ...
    connect(bloatBtn, &QPushButton::clicked, this, [this, bloatBtn]() {
        runAsync(this, m_bloat_, bloatBtn, []() -> std::string {
            ...
            if (!idleRes.success)
                return US("\xD0\x9D\xD0\xB5\xD1\x82\x20\xD1\x81\xD0\xB2\xD1\x8F\xD0\xB7\xD0\xB8\x20\xD1\x81\x20\x31\x2E\x31\x2E\x31\x2E\x31");
            ...
            loader.join();
            if (under.empty()) return US("\xD0\x9D\xD0\xB5\xD1\x82\x20\xD0\xB4\xD0\xB0\xD0\xBD\xD0\xBD\xD1\x8B\xD1\x85\x20\xD0\xBF\xD0\xBE\xD0\xB4\x20\xD0\xBD\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB7\xD0\xBA\xD0\xBE\xD0\xB9\x2E");
            ...
            std::ostringstream out;
            out << US("\xD0\x91\xD0\xB5\xD0\xB7\x20\xD0\xBD\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB7\xD0\xBA\xD0\xB8\x3A\x20") << static_cast<int>(idle) << " ms\n";
            out << US("\xD0\x9F\xD0\xBE\xD0\xB4\x20\xD0\xBD\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB7\xD0\xBA\xD0\xBE\xD0\xB9\x3A\x20") << static_cast<int>(loaded) << " ms\n";
