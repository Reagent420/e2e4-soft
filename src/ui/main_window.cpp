...
void MainWindow::setupUi()
{
    ...
    m_statusLabel = new QLabel(QString::fromUtf8("Ãîòîâî ê ðàáîòå"), statusBarWidget);
    ...
    m_jitterLabel = new QLabel(QString::fromUtf8("Äæèòòåð: --"), statusBarWidget);
    m_jitterLabel->setStyleSheet(metricStyle);
    statusBarLayout->addWidget(m_jitterLabel);
    statusBarLayout->addSpacing(12);

    m_lossLabel = new QLabel(QString::fromUtf8("Ïîòåðè: --"), statusBarWidget);
    ...
    auto* hint = new QLabel(QString::fromUtf8("E2E4 Soft — îïòèìèçàöèÿ èãðîâîé ñåòè"), statusBarWidget);
...
void MainWindow::updateLiveMetrics(int pingMs, int jitterMs, double lossPercent)
{
    ...
    m_jitterLabel->setText(QString::fromUtf8("Äæèòòåð: %1 ìñ").arg(jitterMs));
    m_lossLabel->setText(QString::fromUtf8("Ïîòåðè: %1%").arg(lossPercent, 0, 'f', 1));
