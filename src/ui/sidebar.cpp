    ...
    : QWidget(parent)
{
    ...
    m_versionLabel = new QLabel("v1.2.0", this);
    ...
    m_buttonGroup->addButton(createNavButton(NavPage::Monitoring,  "Мониторинг"),             2);
    m_buttonGroup->addButton(createNavButton(NavPage::Diagnostics, "Диагностика маршрута"),  3);
    m_buttonGroup->addButton(createNavButton(NavPage::History,     "История"),                 4);
    m_buttonGroup->addButton(createNavButton(NavPage::Settings,    "Настройки"),               5);
