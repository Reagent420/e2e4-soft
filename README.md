...
Скачайте `GNO-v1.6.0.zip` со страницы [релизов](https://github.com/Reagent420/e2e4-soft/releases), распакуйте и запустите `GNO.exe`. Qt-библиотеки уже включены в архив.
